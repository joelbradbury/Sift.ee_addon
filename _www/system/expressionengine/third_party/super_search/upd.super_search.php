...
{   
	...
	function __construct ()
    {
        ...
        $this->hooks = array(
        					'entry_submission_absolute_end'	=> array_merge(
	        					$default,
	        					array(
							...
							'channel_entries_query_result'	=> array_merge(
								$default,
								array(
							...
							'sessions_end_processor'	=> array_merge(
								$default,
								array(
							...
							'super_search_extra_basic_fields_tag'	=> array_merge(
								$default,
								array(
							...
							'super_search_alter_ids_tag'	=> array_merge(
								$default,
								array(
