		...
		<tbody>
			...
			*/ ?> 
			<tr class="<?php echo alternator('even', 'odd');?>">
				...
				<td style='width:50%;'>
					<?php $checked = ($value['shipping_is_taxable'] ? TRUE : FALSE) ; ?>
					<label style="display:block;font-weight:normal;"><?=form_checkbox('shipping_is_taxable', '1', $checked)?>&nbsp;<?=lang('yes')?></label>
				</td>
			</tr>
			<tr class="<?php echo alternator('even', 'odd');?>">
				<td>
