...
class Log_model extends CI_Model
{
	...
	public function log($message, $method = FALSE)
	{
		if ($method === 'js')
		{
			...
			echo '<script type="text/javascript">var log = '.$this->EE->javascript->generate_json(array('message' => $message)).'; if (window.console){ window.console.log(log.message); }</script>';
		}
		else
		{
