...
class Paths
{
	...
	public function build_action_url($action, $params = array(), $class = 'Cartthrob')
	{
		return $this->EE->functions->fetch_site_index(0, 0).QUERY_MARKER
	...
	/**
	 * takes a presumed url path and parses out any unparsed url tags
	 * if it's not a url and is rather a template path (ie. site/index), it will convert to a url
	 * 
	 * @param string $path
	 * 
