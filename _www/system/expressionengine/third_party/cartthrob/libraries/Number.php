...
class Number
{
	...
	{
		$this->decimals = $this->EE->cartthrob->store->config('number_format_defaults_decimals');
		
		$this->dec_point = $this->EE->cartthrob->store->config('number_format_defaults_dec_point');
		
		$this->thousands_sep = $this->EE->cartthrob->store->config('number_format_defaults_thousands_sep');
		
		$this->prefix = $this->EE->cartthrob->store->config('number_format_defaults_prefix');

		$this->prefix_position = ($this->EE->cartthrob->store->config('number_format_defaults_prefix_position') ? $this->EE->cartthrob->store->config('number_format_defaults_prefix_position') : "BEFORE"); 
