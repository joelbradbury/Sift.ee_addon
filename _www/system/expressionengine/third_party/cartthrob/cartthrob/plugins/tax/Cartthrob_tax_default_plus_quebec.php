...
class Cartthrob_tax_default_plus_quebec extends Cartthrob_tax
{
	...
	public function get_tax($price)
	{
		...
		{
			$gst_total = $this->core->round($price *  ($this->core->sanitize_number($this->plugin_settings('tax_gst'))/100) );
			return $this->core->round($gst_total * ($this->core->sanitize_number($this->plugin_settings('tax_qst'))/100) );
		}
		else
		{
